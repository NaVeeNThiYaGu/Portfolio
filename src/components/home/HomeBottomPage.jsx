...
const resumeURL = "https://drive.google.com/file/d/1A9Eq5CEifj6HRfgdkfhTGqGqPSuRLtzm/view?usp=sharing";
    ...
    <div className="homeBottom" >
      ...
      <div className="introduction">
        <div className="intro-text">
          <p>
            I am Naveen T, I am a Full Stack Developer{" "}
            {/* <span style={{ color: "#32CD30" }}></span>  */}
          </p>
          <br />
          <p>
            I love working as a <span style={{ color: "#32CD30" }}>Full Stack Developer</span> and My tech stack includes
            NodeJs, React, JavaScript, MySQL.
          </p>
          <br />
          <p>
            I am also proficient in  Java, C++ and love <span style={{ color: "#32CD30" }}>solving problems</span> involving data structures and algorithms.
          </p>
          <br />
          <p>
